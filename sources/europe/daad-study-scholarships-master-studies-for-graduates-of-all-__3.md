...
## Contents
  * [A.Requirements for scholarship application](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#requirements)
  * [B. Preparing your application](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#preparing)
  * [C. Planning your project](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#planning)
  * [D. Writing your application](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#writing)
  * [E. The selection procedure](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#procedure)
  * [F. Scholarship benefits](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#benefits)


##  A. Requirements for scholarship application
  * ### 1. Is there an age limit for DAAD scholarships?
No, there is usually no fixed age limit. There are individual exceptions in programmes in which this is explicitly requested by an international partner. Most scholarship programmes stipulate that only a certain amount of time should have elapsed since the last degree was obtained (see also [question 2](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#daad_accordion_element_anchor_id_1100_1_1234_1)). For details, please refer to the respective Call for Applications at [www.funding-guide.de](http://www.funding-guide.de) under the heading **"Application requirements"**.
...
Information about studying abroad with a disability or chronic illness is provided in the following: [Mobility with a Disability](https://www.daad.de/en/the-daad/mobility-with-a-disability/).
...
Please note that this regulation does not apply to the [**Study scholarships - Master's degree programme for STEM subjects’**](https://www2.daad.de/deutschland/stipendium/datenbank/en/21148-scholarship-database/?status=&origin=&subjectGrps=&daad=&intention=&q=&page=1&detail=57742130) programme. You can apply for this programme if you have completed your studies with a first degree recognised in Germany (e.g. Bachelor's degree) by the application deadline at the latest. 
...
We strongly recommend that you seek information and advice to find out which scholarship programmes are available to you. Contact persons are listed in the [Scholarship database](http://www.funding-guide.de) under **"Contact and advice"**.
  * ### 6. I have dual citizenship. From which country should I apply?
Dual nationals must apply from their country of origin (usually the country where you have spent most of your life). If the requirements are met, an application from the current country of residence is also possible, as described [above (A5)](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#daad_accordion_element_anchor_id_1100_1_1234_4). Nationality alone does not entitle you to apply from a country you have never lived in and are not currently living in.
...
In addition, persons of equal status to Germans according to § 8 Para. 1 Number 2ff. Paragraph 2, Paragraph 2a, and Paragraph 3 BAföG can apply. In this context, the wording of the law applies, which can be found [here](https://www.gesetze-im-internet.de/baf_g/__8.html).
...
Programmes for funding abroad for students in Germany are listed in our scholarship database [www.auslands-stipendien.de](http://www.auslands-stipendien.de).
...
There are also programmes that are aimed at very specific subject areas, such as architecture, music or computer science. In the [Scholarship database](http://www.funding-guide.de), you can select the scholarships programmes that are offered for your subject group.
  * ### 9. What language skills do I need to apply for a scholarship?
Not all programmes require a general minimum language level for funding applications. Depending on country of origin and scholarship programme, however, certain language skills may be expected. When a specific language level is required, this always refers to the [Common European Framework of Reference for Languages (CEFR)](https://www.daad.de/en/studying-in-germany/living-in-germany/cefr/). You can find out which requirements these are in the section **"Application requirements"** and under **"Application documents"** of the Call for Applications. Please read these requirements thoroughly to find out what applies to your programme and your country.
...
Yes, there are internet offers for learning German. For example, the as well as [Deutsche-Uni Online (DUO)](https://www.deutsch-uni.com/gast/duo/info/index.do?do=index&lang=en) offer special online courses in German. For scholarship holders whose funding lasts longer than six months, DAAD will pay the costs of one DUO module.
Furthermore, you can find a wide range of free online content for learning German on Deutsche Welle on [learngerman.dw.com](https://learngerman.dw.com/en/learn-german/s-9528).
...
No, DAAD scholarships are awarded to applicants wishing to complete a full-time course of study with compulsory attendance in Germany. This is why applicants wishing to take a blended learning or distance/e-learning programme or part-time programme (e.g. dual course of study) are not eligible for DAAD funding.
  * ### 12. Can I receive a scholarship if I do not in Germany during the funded study or research project? I plan on continuing to continue living in my home country (a neighbouring country of Germany) during the scholarship and commute or carry out the project online. 
No, the DAAD can only fund you for a study or research project in Germany if you live in Germany for the entire duration of the scholarship.
  * ### 13. I already have a scholarship from the European Union, the DAAD or another organization in Germany. Can I still receive a DAAD scholarship?
...
Further information on the selection criteria can be found at [Section E](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#procedure).
...
On the subject of tuition fees, please also read question [F.7](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#daad_accordion_element_anchor_id_1100_11_1234_6) and the information on our [website](https://www.daad.de/en/studying-in-germany/living-in-germany/finances/) on the costs of living and studying in Germany.
...
The proposal (unless otherwise stated in the scholarship announcement, maximum of 10 pages) should contain details about:
    ...
    * What is your research question?
    1. Key research questions (hypotheses), research objectives and academic relevance of the project:
    * What do you intend to find out?
    * What goals are you pursuing with your project?
    1. Research strategies/methods:
    ...
    * What preparation have you already done or intend doing before funding begins?
    1. Ethical issues/anticipated difficulties related to collecting data
    2. Research bibliography: List of books and essays upon which your work is based.
...
**Declaration of Authenticity:** Applicants must declare that the application was prepared independently, with proper attribution of resources and adherence to the principles of good scientific practice. This declaration also confirms the accuracy and truthfulness of the application. 


##  C. Planning your project
  * ### 1. Do I need contacts in Germany when I apply?
If you wish to carry out individual research or complete a **doctorate** in Germany, you need confirmation from a university teacher that you are being supervised in Germany (see [question 2](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#daad_accordion_element_anchor_id_1100_5_1234_1)). If you are taking part in a structured doctoral programme, proof of existing contacts to a doctoral programme coordinator must be submitted in the form of respective correspondence.
...
These tips on the site [Research in Germany](http://www.research-in-germany.org/en/jobs-and-careers/info-for-phd-students/find-your-phd-place-in-germany/individual-doctorate.html) will help you find an academic supervisor.
...
Information on suitable study programmes can be found, for example, in the database for [international programmes](https://www2.daad.de/deutschland/studienangebote/international-programmes/en/) or [all degree programmes](https://www.hochschulkompass.de/en/study-in-germany.html) in the Higher Education Compass.


##  D. Writing your application
  * ### 1. How do I apply for a DAAD scholarship?
Application procedures may vary depending on scholarship programme. To find out where and how to apply, please read the **"Application procedure"** section of the Call for Applications in the Scholarship database ([www.funding-guide.de](http://www.funding-guide.de)). Seek advice if you have any questions.
Contact persons (often in your area) are listed under **"Contact and advice"**. A list of locations and contact data from the DAAD network is available [here](https://www.daad.de/en/study-and-research-in-germany/plan-your-studies/help-and-advice/regional-offices-and-information-centres/).
  * ### 2. In the Call for Applications it is said that I have to apply through the DAAD portal.
#### What does this mean?
You have to apply online. To do this, you must register in the DAAD portal. In the [scholarship database](http://www.funding-guide.de), first select your chosen scholarship programme and then the tab **"Submit application"**. Note that this tab is only shown during an ongoing application period. The closing date for applications is indicated in the **"Application procedure"** tab.
#### I have technical problems with my online application. What can I do?
If you have access problems or other technical questions about the application portal, please contact portal at daad.de or use the [contact form](https://www.daad.de/en/the-daad/contact/technical-enquiries-about-the-daad-portal/) on the technical portal hotline. You can also call the technical portal hotline on weekdays from 9-12 and 14-16 (CET/CEST) on **+49** -**228-882- 8888.**
...
Find out how to generate a form for the letter of recommendation in the respective Call for Applications in the Scholarship database ([www.funding-guide.de](http://www.funding-guide.de)).
...
**Please note** : When applying for a **place** at a German **university** , you must check the program’s website carefully to find out what language proficiency certificate the university requires. The university may only accept certain language certificates, and a specific language proficiency level may be required.
...
The same applies if you have completed your **bachelor’s degree with German as the language of instruction entirely** in one of these countries (or in Germany) and it was awarded **no more than 3 years** ago.
...
Depending on scholarship programme, additional selection criteria may be relevant, e.g. language skills. To find out what applies to your programme, read the Call for Applications in the Scholarship database ([www.funding-guide.de](http://www.funding-guide.de)).
...
You can find an overview of other possible benefits in each programme's Call for Applications in the Scholarship database ([www.funding-guide.de](http://www.funding-guide.de)).
Scholarship payments will not always be sufficient to cover all living expenses, especially in university towns with high rents, so you may need to contribute some of your own funds. Therefore, make sure you find out exactly what the cost of living is in your chosen location! A general overview of the cost of living in Germany and the average expenses of students can be found here: [https://www.daad.de/de/in-deutschland-studieren/leben-in-deutschland/finanzen/](https://www.daad.de/en/studying-in-germany/living-in-germany/finances/)
  * ### 2. Will I receive travel expenses and what else is important when planning a trip that is as climate-friendly as possible??
DAAD grants an allowance towards travel expenses in the form of a lump sum. You can find more information on the travel allowance in the respective Call for Applications the [Scholarship database](https://www2.daad.de/deutschland/stipendium/datenbank/en/21148-scholarship-database/). Important for planning your trip: The DAAD is committed to climate protection and welcomes your decision in favour of **environmentally friendly travel**. For this reason, the DAAD has developed a Travel Navigator ([German version](https://static.daad.de/media/daad_de/pdfs_nicht_barrierefrei/der-daad/wer-wir-sind/240926_web_daad_factsheet_reisenavigator_stipendiaten_dt_k4.pdf) / [English version](https://static.daad.de/media/daad_de/pdfs_nicht_barrierefrei/in-deutschland-studieren-forschen-lehren/240926_web_daad_factsheet_reisenavigator_stipendiaten_engl_k2.pdf)) to help you plan and carry out your project and your trip in a sustainable and as environmentally friendly way as possible.
The DAAD offers in some funding programmes a topping-up for those travelling by bus or train in addition to the travel allowance. You can find an information sheet [here](https://static.daad.de/media/daad_de/pdfs_nicht_barrierefrei/der-daad/24-nachhaltigkeit_gmtu_engl.pdf). Alternatively, you can also offset air travel. There are various providers where you can offset (for example Atmosfair) - this is possible both before and after travelling. Many DAAD programmes reimburse these payments. If you would like to find out which programmes this applies to and how you can offset emissions, please see [here](https://static.daad.de/media/daad_de/pdfs_nicht_barrierefrei/der-daad/24-nachhaltigkeit_kompen_engl.pdf).
We have compiled more tips on climate-friendly travelling in our [brochure](https://static.daad.de/media/daad_de/pdfs_nicht_barrierefrei/der-daad/was-wir-tun/daad_broschuere_klimavertraeglich_unterwegs.pdf).
  * ### 3. Are there additional benefits for family members?
Under certain conditions, DAAD offers an allowance for accompanying spouses, child allowance and insurance benefits for spouses, registered partners and children ("partner allowance"). For scholarship holders with a funding period of over six months, please read the Call for Applications in the Scholarship database ([www.funding-guide.de](http://www.funding-guide.de)) to find out if a programme provides for family members. If the funding period is less than 6 months, no family benefits will be granted.
The **"partner allowance" is 276 euros per month**. If you are not entitled to state child benefit, you can apply for a DAAD child allowance in the amount of the state child benefit. Currently, you receive **259 euros per month per child**. Information on state child benefit can be found [here](https://familienportal.de/familienportal/meta/languages/family-benefits/child-benefit-141946).
  * ### 4. Do I have to take out health insurance in Germany and does DAAD contribute towards this?
Scholarship holders and accompanying family members **must have health insurance from day one** for the entire duration of their stay in Germany. In many scholarship programmes, insurance benefits are part of the scholarship. The DAAD then usually takes out private health insurance for the scholarship holders and pays the premiums. Please note: **Most pre-existing conditions** (=illnesses that existed **before the start of the insurance**) are covered by the insurance that the DAAD takes out for you. However, there are some **exceptions.** The following pre-existing conditions are **not covered by the insurance** : **HIV, multiple sclerosis, haemophilia (haemophilia), malignant tumour (cancer) including leukaemia and chronic kidney disease. The removal of cosmetic defects and the treatment of anomalies are also excluded from the insurance cover. There is also no obligation to pay benefits for childbirths within 8 months of the start of insurance cover.** It only applies to deliveries that take place from the 9th month after the start of the insurance. **If you have one of these pre-existing conditions or are pregnant, please contact your DAAD contact person directly. The DAAD can only provide funding if insurance cover is guaranteed for these pre-existing conditions. The same applies to pregnancies. You cannot start your stay in Germany without adequate health insurance.** Please also read the announcement in the [scholarship database](https://www2.daad.de/deutschland/stipendium/datenbank/en/21148-scholarship-database/?status=&origin=&subjectGrps=&daad=&q=&page=1&back=1) under the heading ‘**Scholarship benefits** ’. If your chosen programme does not include insurance, you can take out affordable [health, accident and personal liability insurance](https://www.daad.de/en/studying-in-germany/living-in-germany/health-insurance/) through the DAAD at your own expense under certain conditions. If you have any questions about health insurance, please contact the **DAAD insurance office** : versicherungsstelle at daad.de or (+49) 228/882-8770. 
...
DAAD will verify that the part-time employment does not interfere with the purpose of the scholarship. Additional income exceeding **EUR 603 gross per month** shall be deducted from the monthly scholarship payment.
...
A scholarship form another German funding organisation or another state agency in Germany may not be used at the same time as a DAAD scholarship (see also [question A.11](https://www.daad.de/en/studying-in-germany/scholarships/information-for-scholarship-applicants/#daad_accordion_element_anchor_id_1100_1_1234_10)).
...
There may be additional requirements for individual subject areas when applying for a DAAD study scholarship. We have summarised these for you here.
Study & Research Stays in Germany - DAAD Scholarship Programmes
You’d like to study, carry out research or learn German in Germany and are looking for funding? Then look no further! This overview provides you with information about DAAD’s most important scholarship programmes which are offered in numerous countries throughout the world. You can find out which of these programmes is available for a certain country in our scholarship database. The current calls for applications, application deadlines and persons to contact at DAAD are included here.
"Climate-friendly travel" - but how?
How can scholarship holders contribute to developing eco-friendly solutions for the mobility of the future? Where does virtual mobility present new opportunities for sustainable exchange? How can we further reduce the ecological footprint generated by travel? The DAAD is keen to engage in dialogue on this subjects with universities and scholarship holders. Our staff have put together some tips and ideas for sustainable mobility for scholarship holders in Germany.
Opens chatbot
  *[scholarship]: 
  *[Bachelor]: 
  *[Master]: 
